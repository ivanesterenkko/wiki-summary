...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['parent_id'], ['article.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_article_id'), 'article', ['id'], unique=False)
    op.create_index(op.f('ix_article_parent_id'), 'article', ['parent_id'], unique=False)
    ...
    op.create_index(op.f('ix_summary_article_id'), 'summary', ['article_id'], unique=False)
